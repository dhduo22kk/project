...
INNER JOIN INS_INS_CR C
    ...
    AND C.IKD_GRPCD = 'LA'
INNER JOIN INS_INS_CR D      -- CR_STCD 조회용 (NDS 기준)
    ON  D.PLYNO              = B.PLYNO
